...
<div class="container">
    ...
    @endcan
        ...
        <div class="form-group">
            <div class="checkbox col-md-6 col-md-offset-4">
                <label>
                    {!! Form::hidden('public_path', 0) !!}
                    {!! Form::checkbox('public_path', 1, $activity->isPublicPath()) !!}
        ...
        <div class="form-group{{ $errors->has('featured_image') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <div class="input-group col-xs-12">
                    <image-upload api-url="{{ url('api') }}" locale="{{ App::getLocale() }}" input-name="featured_image" :image="{{ $activity->hasFeaturedImage() ? $activity->image : '{}' }}" base-url="{{ url('/') }}"></image-upload>
                </div>
