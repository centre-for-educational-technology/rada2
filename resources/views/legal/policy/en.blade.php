...
<div class="c16">
    ...
    <li class="c0"><span class="c3 c1">Personal data should be relevant to the purposes for which they are to be used, and to the extent necessary for those purposes. Data should be accurate, complete and kept up-to-date;</span></li>
    <li class="c0"><span class="c3 c1">The purposes for which personal data are collected should be specified not later than at the time of data collection;</span></li>
    <li class="c0"><span class="c3 c1">Personal data should not be disclosed, made available or used for purposes other than specified &ndash; except with the consent of the data subject or by the authority of the law;</span></li>
...
<p
class="c2"><span class="c5 c1">3.1.2</span><span class="c3 c1">&nbsp;Registration is not allowed without user consent to Privacy and Terms and Conditions policies. </span></p>
<p class="c2"><span class="c5 c1">3.1.3</span><span class="c3 c1">&nbsp;The Platform may, from time to time, contain links to the websites of third parties. If you follow a link to any of these websites, please bear in mind that these websites have their own privacy policies and that we do not accept responsibility or liability for any of these policies. Please check these policies before you submit any personal information to these websites. </span></p>
<p
class="c2"><span class="c6 c5">4. YOUR RIGHTS </span></p>
<p class="c2"><span class="c5 c1">4.1.</span><span class="c3 c1">&nbsp;You have the right to know what kind of data is being collected about you and for what purposes, how your data are processed, and this information must be available in a clear and understandable way. </span></p>
<p
class="c2"><span class="c5 c1">4.2.</span><span class="c3 c1">&nbsp;You have the right to cancel or correct any information in your user profile. This does not include anonymous information that has already been collected (e.g., reports, scientific publications).</span></p>
<p
class="c2"><span class="c5 c1">4.3</span><span class="c3 c1">. You have the right to unsubscribe from the Platform and email communications. </span></p>
<p class="c2"><span class="c5 c1">4.4.</span><span class="c3 c1">&nbsp;You have the right to be treated with respect, regardless of race, religion, gender, sexual orientation, maternity, marital or family status, disability, age or national origin. </span></p>
<p
...
<li class="c0"><span class="c3 c1">Firewall measures; </span></li>
...
<p class="c2"><span class="c5 c1">5.2</span><span class="c1">. SmartZoos protects all stored data from misuse and respects the rights of the data owners which are guaranteed by the European Union&#39;s (EU) Data Protection Directive 95/46/EC.&nbsp; <br></span>
    ...
    <ol class="c9 lst-kix_list_10-0 start" start="1">
        ...
        <li
        class="c0"><span class="c3 c1">Expiry: Some cookies have no expiration date. Others are deleted after certain amount of days and the moment you close your browser.</span></li>
    </ol>
    <p class="c2"><span class="c8 c5 c1">Web storage features:</span></p>
    <ol class="c9 lst-kix_list_11-0 start" start="1">
        <li class="c4"><span class="c3 c1">Both </span><span class="c5 c1 c8">Session Storage</span><span class="c3 c1">&nbsp;and </span><span class="c8 c5 c1">Local Storage</span><span class="c3 c1">&nbsp;are used in addition to Cookies, those store certain data on the client side that is not directly need to be accessed on the backend server side.</span></li>
        <li
        class="c17"><span class="c3 c1">Examples: Cookie Consent is stored within Local Storage in order not to show the consent screen again to the same user on the same device, information on user already being shown a screen with game instructions is stored in Session Storage.</span></li>
        <li
...
<div>
    <p class="c11"><span class="c1 c7"></span></p>
</div>
</div>
