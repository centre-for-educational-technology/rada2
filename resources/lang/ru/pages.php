...
return [
    ...
    */
    ...
    'welcome' => [
        'jumbotron' => [
            'information' => [
                'heading' => 'Приложение RADA, что это такое?',
                'content' => 'Приложение RADA - это игровой сервис, основанный на местоположении, с помощью которого вы сможете больше узнать о животных и научиться вести за ними наблюдение.',
            ],
            'schools' => [
           'heading' => 'Приложение RADA для общеобразовательных учебных заведений',
                'content' => 'Переместите класс за пределы школы!<br>Приложение RADA - это современный способ обучаться, играя. В роли Разработчика Вы сможете сможете создавать занимательные Учебные тропы, или Игры, в которые будете играть сами или другие пользователи приложения RADA.',
            ],
        ],
        ...
        'project-information' => 'Умные зоопарки (RADA) объединяет зоопарки центральных государств балтийского региона, чтобы сформировать совместную туристическую привлекательность посредством разработки, внедрения и совместного маркетинга трансграничного пакета услуг обучения с помощью мобильных устройств.',
    ],
    'activities' => [
        'index' => [
