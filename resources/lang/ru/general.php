...
return [
   ...
   'forms' => [
       ...
       'placeholders' => [
           ...
           'pin-placeholder' => 'ВВЕДИТЕ ПИН-код',
       ],
       'options' => [
           'any' => 'Любые',
       ],
   ...
   'system-requirements' => 'Минимальные требования: операционная система iOS (версия 14) или Android 8.1. Как минимум 4G интернет и функционирующий GPS-модуль.',
   'messages' => [
       'warnings' => [
