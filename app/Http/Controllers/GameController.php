    ...
    public function getCountOfUngradedAnswers(Request $request, Game $game)
    {
        ...
        if ($game && Auth::check()) {
            ...
            $query = DB::table('game_answers')
                ...
                ->leftJoin('activity_activity_item', 'activity_activity_item.activity_id', '=', $game->activity_id)
                ->where('game_answers.activity_item_id', '=', 'activity_activity_item.activity_item_id')
