...
class Activity extends Model
{
    ...
    public function getGameData() {
        $data = [
            ...
            'type' => $this->getActivityType($this->type),
            'difficulty_level_start' => $this->difficulty_level_start,
            'difficulty_level_end' => $this->difficulty_level_end,
            'playing_time' => $this->playing_time,
            'language' => trans('general.languages.' . $this->language),
            'contact_information' => $this->contact_information,
            'featured_image' => $this->getFeaturedImageUrl(),
            'zoo' => $this->getZoo($this->zoo),
            'questions' => [],
        ];
